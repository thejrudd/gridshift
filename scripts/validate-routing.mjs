...
const validatedPaths = [
  ...
  expectRoundTrip({ activeTab: 'fantasy', companionView: 'injuries' }, '/fantasy/injuries'),
  ...
  expectRoundTrip({ activeTab: 'fantasy', companionView: 'defenses', defenseMode: 'fantasy', defensePosition: 'QB', defenseStat: 'pass_yd', defenseSort: 'team', defenseDir: 'asc', defenseQuery: 'KC' }, '/fantasy/defenses?mode=fantasy&pos=QB&sort=team&dir=asc&q=KC'),
