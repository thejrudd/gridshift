...
export default function PlayerMatchupBreakdown({ playerId, week, projection, onClose }) {
            ...
            <>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {diff !== null && (
                    <span
                      ...
                      style={{
                        ...
                        color: metProjection ? '#22c55e' : 'var(--color-accent-red)',
                      }}
                    >
                  ...
                  <span
                    className="text-right text-xl font-bold tabular-nums"
