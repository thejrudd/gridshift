...
flowchart TD
  ...
  S --> S1[Immutable snapshots]
  S --> S2[Portable links and QR]
  S --> S3[Fixed-format cards]
  ...
  N --> N1[Season score board]
  N --> N2[Game box score]
  N --> N3[Normalized fixtures]
